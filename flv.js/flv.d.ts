...
declare namespace flvjs {
    ...
    interface Player {
        ...
        createdTime: number;
        one(event: string, listener: (...args: any[]) => void): void;
        _transmuxer: {
            _controller: {
                _ioctl: {
                    _speedSampler: {
        ...
        _emitter: {
            removeAllListeners: (v: string) => void;
        }
    }
    ...
    interface Events {
        ...
        HTTP_REQUEST_ENDED: string;
        P2P_REQUEST_ENDED: string;
        HTTP_HEADER_RECEIVED: string;
        AUDIO_FRAME_DECODED: string;
        VIDEO_FRAME_DECODED: string;
        CTS_WARNING: string;
        FLV_DATA_ABNORMAL: string;
    ...
    interface ErrorDetails {
        ...
        ABNORMAL_SEGMENT_BYTELENGTH: string;
    }
}
